        ...
        () => [
            {
                ...
                desktopImage: "/images/slides/helmet/1.jpg",
                mobileImage: "/images/slides/helmet/1.jpg",
                title: "Choice of Helmets at <br /> your doorstep!",
                details:
            ...
            {
                url: "/catalog/batteries/products",
                desktopImage: "/images/slides/helmet/2.jpg",
                mobileImage: "/images/slides/helmet/2.jpg",
                title: "Got your Helmet <br> Damaged?",
                details: "Wegtra will help you any of your tyre needs. <br> Browse flat tyre toolkits now!",
                buttonLabel: "Shop Now",
            },
            {
                url: "/catalog/batteries/products",
                desktopImage: "/images/slides/helmet/3.jpg",
                mobileImage: "/images/slides/helmet/3.jpg",
                title: "Big Choice Of <br>Helmets",
        ...
        <React.Fragment>
            <div className="p-md-5">
                ...
                <div className="col-md-12 mt-md-4 pt-sm-5">
                    <div className="site-heading text-center">
                        <h2>Find Helmets by Your Preference</h2>
                    </div>
                </div>
                <VehicleChooser />
                <SearchByModel />
