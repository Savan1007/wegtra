...
const shopCategoriesDef: ICategoryDef[] = [
    ...
    },
    {
        ...
        items: 508,
        children: [
            { name: 'Wheel Covers', slug: 'wheel-covers', image: '/images/categories/category-7.jpg' },
            { name: 'Brake Kits', slug: 'brake-kits', image: '/images/categories/category-7.jpg' },
            { name: 'Tire Chains', slug: 'tire-chains', image: '/images/categories/category-7.jpg' },
            { name: 'Wheel disks', slug: 'wheel-disks', image: '/images/categories/category-7.jpg' },
            { name: 'Tires', slug: 'tires', image: '/images/categories/category-7.jpg' },
            { name: 'Sensors', slug: 'sensors', image: '/images/categories/category-7.jpg' },
            { name: 'Accessories', slug: 'tires-wheels-accessories', image: '/images/categories/category-7.jpg' },
        ],
    },
    {
        name: 'Engine & Drivetrain',
        slug: 'engine-drivetrain',
        image: '/images/categories/engine.png',
        items: 95,
        children: [
