...
import VictoriaMemorial from './victoria-memorial.svg';
import ChennaiStation from './chennai-central-railway-station.svg';
import JhultMinarAhamadabad from './jhulta-minar.svg';
...
export const HawaMehalSvg = HavaMahal;
